...
import { evaluateHeuristic, buildEvolvePrompt } from '@freeagentstore/sdk';
```

## MCP tools

Connect via `npx mcp-remote https://mcp.freeagentstore.online/mcp`
