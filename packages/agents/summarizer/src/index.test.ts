...
import { createDefaultConfig, createMeetingNotesConfig, buildPromptFromConfig, heuristicSummarize } from './index';
...
describe('heuristicSummarize', () => {
  ...
  it('extracts key sentences from long text', () => {
    const text = 'The experiment began in January. We collected data from 500 participants. The weather was nice. Results show a significant improvement of 30%. Several limitations exist. In conclusion, the method works.';
  ...
  it('prioritizes first and last sentences', () => {
    const text = 'First important point. Some filler. More filler. Another filler. Last conclusion point.';
